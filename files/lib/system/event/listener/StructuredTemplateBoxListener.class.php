...
class StructuredTemplateBoxListener implements EventListener {
	...
	public function execute($eventObj, $className, $eventName) {
		...
		// box stylesheet
		$html = '<link rel="stylesheet" type="text/css" media="screen" href="'.RELATIVE_WBB_DIR.'style/box.css" />
			<link rel="stylesheet" type="text/css" media="print" href="'.RELATIVE_WBB_DIR.'style/boxPrint.css" />
			<style type="text/css">
				#mainContainer {
					'.WBBCore::getStyle()->getVariable('page.alignment.margin').(WBBCore::getStyle()->getVariable('page.width') !== '' ? 'width:'.WBBCore::getStyle()->getVariable('page.width') : 'max-width:'.WBBCore::getStyle()->getVariable('page.width.max').';min-width:'.WBBCore::getStyle()->getVariable('page.width.min').';').'
				}
			</style>';
